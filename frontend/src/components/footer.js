...
function Footer() {
  return (
    <section className="footer center">
      <article className="center footer__contacts">
        <a href="tel: #" className="footer__contacts_contact">
          Phone: +7838383838
        </a>
        <a href="email: #" className="footer__contacts_contact">
          Email: xxxConiaxxx@mail.ru
        </a>
      </article>
